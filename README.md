...
2. Clone the repo
   ```sh
   git clone https://github.com/MartinSvanholm/CSGOServerPackage.git
   ```
...
See the [open issues](https://github.com/MartinSvanholm/CSGOServerPackage/issues) for a full list of proposed features (and known issues).
